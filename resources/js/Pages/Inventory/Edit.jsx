...
export default function Edit({ auth, inventory }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        foto: null,
        is_public: Boolean(inventory.is_public),
    });
        ...
        <AuthenticatedLayout
            ...
            header={
                <div className="flex justify-between items-center">
                    <div>
                        <h2 className="font-bold text-2xl text-gray-800">Edit Barang</h2>
                        <p className="text-gray-500 text-sm">Perbarui data inventaris</p>
                    </div>
                    <Link
                ...
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <div className="flex flex-col items-center justify-center p-6 border-2 border-dashed border-gray-300 rounded-2xl hover:bg-gray-50 transition-colors relative cursor-pointer" onClick={() => document.getElementById('foto').click()}>
                        {data.foto ? (
                            ...
                            <div className="relative w-full max-w-xs h-48 rounded-lg overflow-hidden">
                                <img src={`/storage/${inventory.foto}`} alt="Current" className="w-full h-full object-cover" />
